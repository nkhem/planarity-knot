...
const Graph = function(opts = {}){
  ...
  this.points = [];
  this.pointPositions = [];
  this.allIntersectPositions = [];
};

Graph.prototype.populate = function (n) {
  this.makePoints(n);
  this.makeLines();
  this.allIntersectionPoints = Line.allIntersectionPoints(this.lines);
};
...
Graph.prototype.allObjects = function () {
  return [].concat(this.lines, this.points, this.allIntersectionPoints);
};
