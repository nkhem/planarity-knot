...
Graph.prototype.setLinesAndPoints = function (opts) {
  ...
  if (isRestoringLevel) {
    this.points = premadePoints;
    this.initialPoints = premadePoints;
    this.pointPositions= premadePointPositions;
    this.initialPointPositions= premadePointPositions;
    console.log('isRestoringLevel!,', this);
    console.log('this.points',this.points);
  } else {
    this.makePoints(numPoints);
  }
  console.log('outsdie if isRestoringLevel!,', this);

  this.makeBaseLines(numPoints);
  this.makeConnectingLines(numConnectingLines);
  console.log('at setLinesAndPoints:', this);
  this.setIntersectionData(this.lines);
};

Graph.prototype.setIntersectionData = function(lines){
  console.log('at setIntersectionData:');
...
Graph.prototype.makeBaseLines = function(n){
  ...
  console.log('at makeBaseLines:', this.lines);
};
...
Graph.prototype.makeConnectingLines = function(n){
  ...
  console.log('at makeConnectingLines:', this.lines);
