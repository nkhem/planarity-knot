...
Graph.prototype.restoreStartingGraph = function () {
  //keep relevant data
  this.points = this.levelStartingPoints;
  this.pointPositions = this.levelStartingPointPositions;
  this.lines = this.levelStartingLines;
  ...
  this.timer = null;
  this.elapsedTime = 0;
  this.levelStartingPoints = [new NullObject()];
  this.levelStartingPositions = [new NullObject()];
  this.levelStartingLines = [new NullObject()];
  this.movingPoint = new NullObject();
  this.movingLines = [new NullObject()];
  this.redrawGameView();
};

Graph.prototype.storeLevelData = function () {
  this.levelStartingPoints = this.points;
  this.levelStartingPositions = this.pointPositions;
  this.levelStartingLines = this.lines;
};
