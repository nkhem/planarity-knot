...
Line.prototype.intersectionPos = function (otherLine) {
  ...
  let commonX = Math.floor((otherLine.yIntercept - this.yIntercept)/(this.slope - otherLine.slope));
  let commonY = Math.floor((this.slope * commonX) + this.yIntercept);
